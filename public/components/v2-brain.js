/* v2-brain.js
   Ambient point-cloud canvas backdrop. Self-mounting: creates <canvas class="brain-bg"> and prepends it to <body> if absent. v2-base.css keys the legibility scrim off body:has(.brain-bg), so the scrim only appears on pages that load this.

   Ported verbatim from team-july2026-multipager/js/brain.js.
