...
(function() {
  ...
  const L = window.TEAM_LINKS || {
    ...
    enterprise: '/enterprise', pricing: '/pricing',
    artists: '/for-artists', managers: '/for-managers',
    labels: '/for-labels', partners: '/for-partners',
    about: '/about', insights: '/insights', changelog: '/changelog',
    contact: '/contact', demo: '/demo',
    privacy: '/privacy', terms: '/terms', smsTerms: '/sms-terms',
...
<footer class="footer">
  ...
  <div class="footer__grid">
    ...
    <div>
      ...
      <a href="${L.about || '/about'}" class="footer__link">About</a>
      <a href="${L.insights}" class="footer__link">Insights</a>
      <a href="${L.changelog}" class="footer__link">Changelog</a>
      <a href="${L.contact || '/contact'}" class="footer__link">Contact</a>
      <a href="${L.demo}" class="footer__link">Book a Demo</a>
    </div>
    <div>
      <div class="footer__col-title">Legal</div>
      <a href="${L.privacy || '/privacy'}" class="footer__link">Privacy Policy</a>
      <a href="${L.terms || '/terms'}" class="footer__link">Terms of Service</a>
      <a href="${L.smsTerms || '/sms-terms'}" class="footer__link">SMS Terms</a>
      <a href="${L.cookiePolicy || '/cookie-policy'}" class="footer__link">Cookie Policy</a>
