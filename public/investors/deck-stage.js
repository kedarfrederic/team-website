 ...
 *
 * Handles:
 *  (a) speaker notes, reads \x3cscript type="application/json" id="speaker-notes">
 ...
 *   <template id="__bundler_thumbnail"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400"><rect width="400" height="400" fill="#17161A"/><text x="200" y="235" font-family="Georgia,serif" font-style="italic" font-size="150" fill="#E83E18" text-anchor="middle">t.</text></svg></template>
<deck-stage width="1920" height="1080">
 *     <section data-label="Title">...</section>
 *     <section data-label="Agenda">...</section>
 *   </deck-stage>
 *   \x3cscript src="deck-stage.js"><\/script>
 *
 ...
 *     and retype it directly; a slide rendered through \x3cscript type="text/babel">,
    ...
    _render() {
      ...
      overlay.innerHTML = `
        <button class="btn prev" type="button" aria-label="Previous slide" title="Previous (←)">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M10 3L5 8l5 5"/></svg>
        </button>
